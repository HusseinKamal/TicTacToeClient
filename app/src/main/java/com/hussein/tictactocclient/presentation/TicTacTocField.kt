package com.hussein.tictactocclient.presentation
...
import com.hussein.tictactocclient.data.GameState
...
fun TicTacTocField(
    ...
    Canvas(modifier = modifier
        .pointerInput(true){
            detectTapGestures {
                //This to get specific cell clicked and track user tap on it
...
private fun DrawScope.drawX(
    ...
    drawLine(
        ...
        cap = StrokeCap.Round //Rounded line at edges
    )
